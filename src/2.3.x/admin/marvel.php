...
// Cache
$registry->set('cache', new Cache('file', 86400));
...
// Route
$route = new Front($registry);

// Startup
$route->addPreAction(new Action('startup/startup'));

// Dispatch
$route->dispatch(new Action('extension/module/marvel/cron'), new Action($config->get('action_error')));
